...
<div class="container-fluid">
    <div class="row">
        <div class="col-6 mx-auto">
            <form id="form_login" action="../../app/Config/UserControllerUpdate.php" method="POST"
                onsubmit="//getData(this.id,event)">
                    ...
                    <div class="row">
                        <div class="mb-3 col-6">
                            <label for="User_user" class="form-label">Email
                                address</label>
                            <input type="email" class="form-control input_disabled" maxlength="50" minlength="10"
                                name="User_user" id="User_user" value="<?= $getDataUser[0][1] ?>"
                        ...
                        <div class="mb-3  col-3">
                            ...
                            <select class="form-select" aria-label="Default select example" name="User_status_id"
                                id="User_status_id">
                                <option>Open this select
                                    menu</option>
                                <?php
